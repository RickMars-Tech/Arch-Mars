...
paru -S --noconfirm bashtop-git eww-wayland-git grimblast-git gtklock heroic-games-launcher-bin \
...
pacman -Syu --needed --noconfirm acpi alsa-lib alsa-plugins bashtop \
    ...
    libvulkan-radeon libxwayland lutris mpv ncurses neofetch nautilus networkmanager \
